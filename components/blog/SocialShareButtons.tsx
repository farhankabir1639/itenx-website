  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <a
        ...
        className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/20 bg-white/5 text-slate-400 transition-colors hover:border-[#00D8FF]/40 hover:bg-[#00D8FF]/10 hover:text-[#00D8FF]"
        aria-label="Share on X (Twitter)"
      >
        {icons.twitter}
      </a>
      <a
        href={shareLinks.linkedin(url)}
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/20 bg-white/5 text-slate-400 transition-colors hover:border-[#00D8FF]/40 hover:bg-[#00D8FF]/10 hover:text-[#00D8FF]"
